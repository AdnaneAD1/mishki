    ...
    <footer className="bg-[#235730] text-white py-12">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            <h3 className="font-semibold text-lg mb-4">Qui Nous</h3>
            <ul className="space-y-2">
              <li>
          ...
          <div>
            <h3 className="font-semibold text-lg mb-4">Rejoignez-nous ici</h3>
            <p className="text-sm opacity-90 mb-4">
              Suivez-nous sur nos reseaux sociaux pour decouvrir nos dernieres actualites et conseils beaute.
            </p>
        ...
        <div className="border-t border-white/20 mt-8 pt-8 text-center text-sm opacity-80">
          <p>Mishki. Tous droits reserves.</p>
        </div>
      </div>
    </footer>
  )
